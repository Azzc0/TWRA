...
function onOpen() {
  ...
  menu.addSubMenu(ui.createMenu('Short Raids')
    .addItem('Emerald Secantim', 'generateEmeraldSanctum')
    .addItem('Onyxia\'s Lair', 'generateOnyxia'));
...
function generateEmeraldSanctum() {
  showGeneratedTWRAPopup("Emerald Sanctum", ["Emerald Sanctum"]);
}
